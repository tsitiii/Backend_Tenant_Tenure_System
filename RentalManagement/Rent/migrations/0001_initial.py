    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kebele', models.CharField(max_length=3, null=True, validators=[django.core.validators.RegexValidator(message='The kebele must be a number.', regex='^\\d+$')], verbose_name='Kebele')),
                ('unique_place', models.TextField()),
                ('house_number', models.PositiveBigIntegerField(blank=True, null=True)),
                ...
                ('kebele_ID', models.ImageField(upload_to='')),
                ('role', models.CharField(choices=[('is_admin', 'Administrator'), ('is_tenant', 'Tenant'), ('is_tenure', 'Tenure'), ('is_witness', 'Witness')], max_length=30, null=True)),
